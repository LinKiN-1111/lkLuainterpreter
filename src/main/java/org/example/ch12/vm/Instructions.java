...
import org.example.ch12.api.ArithOp;
import org.example.ch12.api.CmpOp;
import org.example.ch12.api.LuaVM;

import static org.example.ch12.api.ArithOp.*;
import static org.example.ch12.api.CmpOp.*;
import static org.example.ch12.api.LuaType.LUA_TSTRING;
...
public class Instructions {
    ...
    public static void tForCall(long i, LuaVM vm) {
        int[] registers = Instruction.ABC(i);
        int A =  registers[0] + 1;
        int C =  registers[2];
    ...
    public static void tForLoop(long i, LuaVM vm) {
        int[] registers = Instruction.AsBx(i);
        int A = registers[0] + 1;
        int sBX = registers[1];
        if(!vm.isNil(A+1)){
            vm.copy(A+1,A);
